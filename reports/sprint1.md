...
- добавить Telegram-бота на aiogram;
- добавить реальный LLM-клиент;
- расширить draft reply;
- добавить историю анализов в пользовательском интерфейсе;
- подготовить demo-ready сценарий защиты.
