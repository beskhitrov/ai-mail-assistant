...
Он принимает текст письма через HTTP API или Telegram, анализирует его с помощью LLM и помогает пользователю быстрее работать с входящей почтой.
...
Репозиторий находится на этапе Sprint 2 demo-ready версии. Сервис
собран в воспроизводимое Docker Compose окружение, покрыт базовыми
проверками и снабжен Sphinx-документацией.
...
- история анализов;
- Makefile-команды для запуска, проверок и сборки документации;
- GitHub Actions CI;
- Sphinx-документация и workflow публикации через GitHub Pages;
- тесты ключевого сценария;
- отчеты `reports/sprint1.md` и `reports/sprint2.md`.
...
Telegram-бот, demo-ready запуск через Docker Compose, Makefile-команды,
CI, Sphinx-документация и публикация документации через GitHub Pages.
